        ...
        <div class="card z-index-0">
          ...
          <div class="card-body">
            <form role="form text-left" method="POST" action="/register">
              @csrf
              <div class="mb-3">
                <input type="text" class="form-control" placeholder="Prénoms et Nom" name="name" id="name" aria-label="Name" aria-describedby="name" value="{{ old('name') }}">
                @error('name')
              ...
              <div class="mb-3">
                <input type="number" class="form-control" placeholder="221..." name="phone" id="phone" aria-label="phone" value="{{ old('phone') }}">
                @error('phone')
                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                @enderror
              </div>
