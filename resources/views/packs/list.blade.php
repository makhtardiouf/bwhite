    ...
    <div class="card-body p-2">
        <div class="row">
                ...
                <div class="card card-blog card-plain">
                    ...
                    <div class="card-body px-1 pb-0">
                        ...
                        <p class="mb-4 text-sm">
                            Poster vos annonces à 1000fr dans une plateforme pas encore saturée où toutes les annonces seront visibles grâce à notre système de partage
                            en dehors même du site couvrant tous les réseaux sociaux avec un lien renvoyant directement vers la plateforme B-white Sénégal.
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <a href="/packs/annonceur">
                                <button type="button" class="btn btn-outline-info btn-sm mb-0">Souscrire</button>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body px-1 pb-0">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <a href="/packs/merchant">
                                <button type="button" class="btn btn-outline-danger btn-sm mb-0">Souscrire</button>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-md-6 mb-xl-0 mb-4">
                <div class="card card-blog card-plain">
                    <div class="position-relative">
                        <a class="d-block shadow-xl border-radius-xl" href="/packs/invest">
                    ...
                    <div class="card-body px-1 pb-0">
                        ...
                        <p class="mb-4 text-sm">
                            ...
                            A 50.000fr seulement vous obtenez votre propre espace privé dans la plateforme B-white Sénégal
                            par lequel passeront vos propres clients pour rejoindre la plateforme, Vos clients une fois dedans vous bénéficierez de tout article acheté sur le site même si vous dormiez ; en effet c’est comme si tous les produits de la plateforme vous appartiennent. </p>
                        
                            <div class="d-flex align-items-center justify-content-between">
                            <a href="/packs/invest">
                                <button type="button" class="btn btn-outline-success btn-sm mb-0">Souscrire</button>
                            </a>
